...
const SignupPage = () => {
    return (
        ...
        <div className="relative"  style={{ background: 'linear-gradient(to bottom right, #a834eb, #9d03fc, #606091,#a834eb, #9d03fc, #9d03fc)'}}>
            ...
            <div className="relative w-96 h-auto bg-gray-50 bg-opacity-30 border border-pink-300 rounded-xl p-8">
                ...
                <div className="mb-4">
                    <div className="relative">
                        ...
                        <UserIcon className="w-6 h-6 bg-transparent text-white" />
                        </span>
                        <input
                            type="email"
